...
import com.binh.core.ui.theme.CoreTheme

/**
 * Core view toggle button with included trailing icon as well as compact and expanded
...
fun CoreViewToggleButton(
    ...
    TextButton(
        ...
        CoreViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) CoreIcons.ViewDay else CoreIcons.ShortText,
...
/**
 * Internal Core view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun CoreViewToggleButtonContent(
...
/**
 * Core view toggle default values.
 */
