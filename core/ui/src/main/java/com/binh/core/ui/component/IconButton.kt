...
/**
 * Core toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
        ...
        colors = IconButtonDefaults.iconToggleButtonColors(
            ...
            disabledContainerColor = if (checked) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = CoreIconButtonDefaults.DISABLED_ICON_BUTTON_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
fun IconButtonPreview() {
    CoreTheme {
        CoreIconToggleButton(
            checked = true,
            onCheckedChange = { },
            icon = {
                Icon(
                    imageVector = CoreIcons.BookmarkBorder,
                    contentDescription = null,
                )
            },
            checkedIcon = {
                Icon(
                    imageVector = CoreIcons.Bookmark,
                    contentDescription = null,
                )
            },
        )
...
/**
 * Core icon button default values.
 */
object CoreIconButtonDefaults {
